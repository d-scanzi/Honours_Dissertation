...
bayesData <- trialSubtracted %>% 
  ...
  dplyr::filter(time_point >= n2pcTime [['start']] & time_point <= n2pcTime [['stop']]) %>% 
...
bayesPlot1 <- dataToPlot %>%   
  ...
  ggridges::geom_density_ridges(aes(x      = value,
                                ...
                                scale          = 0.8, 
                                alpha          = 1) +
  # Add HDI as horizontal errorbars
